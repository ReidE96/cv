...
\section{Education}
	\cventry{2009--2014}{BEng Software Engineering}{University of Edinburgh}{UK}{\textbf{(Ongoing)}}{  % arguments 3 to 6 can be left empty
		...
		Courses included Algorithms and Data Structures \grade{40}, Object-Oriented Programming \grade{100}, Functional Programming \grade{97}, Computer Security \grade{65}, Operating Systems \grade{46}, and\newline{}Software Testing \grade{69}, plus a series of Mathematics for Informatics courses.
%
...
%
		...
		The project aims to build a tool, based on blame calculus (a simple way to interface statically, dynamically, and polymorphically typed languages), to enable cross-module type declarations in Javascript, monitoring type discipline and reporting which module is at fault should\newline{}discipline be violated.
	}
...
\section{Experience}
	...
	\cventry{Jun 2012 --
	Sept 2012}{Backend Developer}{Accendo Design}{Edinburgh}{}{LAMP development at fast-paced startup, developing a web-based tool for property \newline{}management powered by ooPHP. Also created PINFUD markup language for UX design, and wrote Javascript code for frontend}
